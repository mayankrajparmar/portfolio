        ...
        <div className=" px-4 flex flex-col">
          ...
          <div className="flex flex-col px-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-green-400">{`'Junior Software Developer at SearchingYard Group'`}</p>
              <p className="text-milk">{`},`}</p>
            </div>
            <div className="flex items-center gap-2">
              <p className="text-milk">{`{`}</p>
              ...
              <p className="text-green-400">{`:`}</p>
              <p className="text-green-400">{`'Web Developer Intern at OtakuKart'`}</p>
              <p className="text-milk">{`},`}</p>
            </div>
            <div className="flex items-center gap-2">
              <p className="text-milk">{`{`}</p>
              ...
              <p className="text-green-400">{`:`}</p>
              <p className="text-green-400">{`'AWS Cloud Intern at AICTE NEAT'`}</p>
              <p className="text-milk">{`},`}</p>
            </div>
          </div>
          <p className="text-milk">{`]`}</p>
        ...
        <div className=" px-4 flex flex-col">
          ...
          <div className="flex flex-col pl-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-green-400">{`:`}</p>
              <p className="text-green-400">{`'Gandhi Institute For Education And Technology - B.Tech (CSE) `}</p>
              <p className="text-milk">{`},`}</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-green-400">{`:`}</p>
              <p className="text-green-400">{`'M.G.S.Sr.Sec School - 12th (Science)'`}</p>
              <p className="text-milk">{`},`}</p>
            </div>
          </div>
          <p className="text-milk">{`]`}</p>
